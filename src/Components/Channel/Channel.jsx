  ...
  return (
    <>
        ...
        <div className="channel__hero__left">
          <div className="channel__hero__user">
            ...
            <div className="channel__hero__box">
              <h3 className="channel__hero__title">Margaret Phelps</h3>
              <span className="channel__hero__follow">245K subscribed</span>
            </div>
          </div>
        </div>
          ...
          <div className="channel__center">
            <div className="channel__box">
              ...
              <div className="channel__box__sentence">
                ...
                <p className="channel__box__views">11k views · 6 months ago</p>
              </div>
            </div>
          </div>
        </div>
        <div className="channel__right">
          <p className="channel__right__title">Recommended channel</p>
      ...
      <div className="channel__bottom">
        <h3 className="channel__bottom__title">Margaret Phelps videos</h3>
        <div>
            ...
            <li className="channel__item" key={channelImg.id}>
              <NavLink to={"/video"}>
                <img
                  ...
                  height={150}
                  onClick={() => {
                    videoFunc(channelImg.url, channelImg.title);
                  }}
                />
